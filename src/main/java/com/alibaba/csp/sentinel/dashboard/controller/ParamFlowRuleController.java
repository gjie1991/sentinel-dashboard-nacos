...
import com.alibaba.csp.sentinel.dashboard.nacos.param.ParamFlowFlowRuleNacosProvider;
import com.alibaba.csp.sentinel.dashboard.nacos.param.ParamFlowFlowRuleNacosPublisher;
...
public class ParamFlowRuleController {
    ...
    @Autowired
    private ParamFlowFlowRuleNacosProvider ruleProvider;
    @Autowired
    private ParamFlowFlowRuleNacosPublisher rulePublisher;
    ...
    public Result<ParamFlowRuleEntity> apiUpdateParamFlowRule(@PathVariable("id") Long id,
                                                              @RequestBody ParamFlowRuleEntity entity) throws Exception {
